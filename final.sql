...
/* ================================================================
   ...
   Type mapping applied (per source Oracle types):
     ...
     DATE / DATETIME2(6) -> kept as-is (native Stage type, no cast)
   ================================================================ */
...
(
    ...
    DW_INS_DTTM              DATETIME2(6)    NULL,
    DW_UPD_DTTM               DATETIME2(6)    NULL
);
GO
...
(
    ...
    SRC_UPD_TS                   DATETIME2(6)   NULL,
    SRC_INS_TS                   DATETIME2(6)   NULL
);
GO
